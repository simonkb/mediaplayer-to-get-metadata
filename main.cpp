...
int main(int argc, char *argv[])
{
    ...
    MetadataImageProvider *imageProvider = new MetadataImageProvider();
    engine.addImageProvider(QLatin1String("metadataCoverArt"), imageProvider);
    engine.rootContext()->setContextProperty("metadataImageProvider", imageProvider);
