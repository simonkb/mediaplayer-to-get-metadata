...
Window {
    ...
    MediaPlayer {
        ...
        onPlaybackStateChanged: {
            console.log("dddd Title ", mediaPlayer.metaData.value(0))
            console.log("dddd Artist ", mediaPlayer.metaData.value(20))
            console.log("dddd Thumbnail ", mediaPlayer.metaData.value(24))
        }
    }
    ...
    Image{
        ...
        width: 200
        height: 200
        source: getImageUrl(mediaPlayer.metaData.value(24))
    }
